...
allocate(alpha_vector(0:N-2), beta_vector(0:N-1), gamma_vector(1:N-1), b_vector(0:N-1))
! For BC:
...
allocate(alpha_vector(0:M-2), beta_vector(0:M-1), gamma_vector(1:M-1), b_vector(0:M-1))
! For BC:
beta_vector(0) = 1.d0
alpha_vector(0) = 0.d0
b_vector(0) = T_x
